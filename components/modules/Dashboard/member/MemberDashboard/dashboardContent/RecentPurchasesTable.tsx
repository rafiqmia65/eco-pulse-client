...
import { ShoppingBag, Calendar, Layers, ExternalLink } from "lucide-react";
              ...
              <Table>
                <TableHeader className="bg-muted/20">
                  <TableRow className="hover:bg-transparent border-border/40">
                    <TableHead className="px-6 py-4 text-[11px] uppercase tracking-wider font-bold text-muted-foreground w-75">
                      Idea
                    </TableHead>
